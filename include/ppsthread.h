...
struct pps_thread_t
{
	...
	char* (*report_hook)(volatile struct pps_thread_t*, struct timedelta_t*);
	void (*log_hook)(volatile struct pps_thread_t*, int errlevel, const char* fmt, ...);
...
#	define THREAD_WARN  3
#	define THREAD_INF   2
#	define THREAD_PROG  1
#	define THREAD_RAW   0
...
extern void pps_thread_fixin(volatile struct pps_thread_t*, volatile struct timedelta_t*);
extern void pps_thread_qErrin(volatile struct pps_thread_t* pps_thread, long qErr, struct timespec qErr_time);
extern int  pps_thread_ppsout(volatile struct pps_thread_t*, volatile struct timedelta_t*);
