 ...
 * @param dsc_params_V1
 */
static void convert_disciplining_parameters_V0_to_V1(struct disciplining_parameters_V_0* dsc_params_V0,
                                                     struct disciplining_parameters_V_1* dsc_params_V1)
{
                                             ...
                                             struct disciplining_parameters* dsc_params)
{
	...
	else if (!check_header_valid(dsc_config_data[0]) && !check_header_valid(temp_table[0]))
	{
		...
		memcpy(((uint8_t*)&dsc_params_V0) + DISCIPLINING_CONFIG_FILE_SIZE * sizeof(char),
		       temp_table,
		       sizeof(struct disciplining_parameters_V_0) - DISCIPLINING_CONFIG_FILE_SIZE);
