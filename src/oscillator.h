...
typedef int (*oscillator_get_ctrl_cb)(struct oscillator* oscillator, struct oscillator_ctrl* ctrl);
typedef int (*oscillator_save_cb)(struct oscillator* oscillator);
typedef int (*oscillator_parse_attributes_cb)(struct oscillator* oscillator, struct oscillator_attributes* attributes);
...
typedef struct calibration_results* (*oscillator_calibrate_cb)(struct oscillator*             oscillator,
                                                               ...
                                                               int                            phase_sign);
typedef int (*oscillator_get_phase_error_cb)(struct oscillator* oscillator, int64_t* phase_error);
